        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bolder m-0">User Profile Details</h3>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form class="form" method="POST" action="{{ route('customer_account_update', $users->id)}}" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Card body-->
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <!--begin::Image input-->
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{$users->avatar}}')">
                                    <!--begin::Preview existing avatar-->
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ asset('images/' . $users->avatar) }}')"></div>
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 fv-row">
                                        <input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="First name" value="{{ $users->name}}" />
                                    </div>
                                    <!--end::Col-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="tel" name="phone" value="{{ $users->phone}}" class="form-control form-control-lg form-control-solid" placeholder="Phone number" />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <input type="text" value="{{ $users->address}}" name="address" class="form-control form-control-lg form-control-solid" placeholder="Company website" />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <textarea class="form-control form-control-lg form-control-solid" value="{{ $users->bio}}" name="bio">{{ $users->bio}}</textarea>
                            </div>
                        </div>
                        <!--begin::Input group-->
                        <div class="row mb-6">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-3 fv-row">
                                <input type="date" name="date_of_birth" value="{{ $users->date_of_birth}}" class="form-control form-control-lg form-control-solid">
                            </div>
                        </div>
                    </div>
                    <!--end::Card body-->
