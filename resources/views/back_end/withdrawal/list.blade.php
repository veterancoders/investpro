                                    ...
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('changewithdrawalStatus', [ $withdraw->id, 'status' => 'approved' ] ) }}" class="menu-link px-3">Approve</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('changewithdrawalStatus', [ $withdraw->id, 'status' => 'unapproved' ]) }}" class="menu-link px-3">Unapprove</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('changewithdrawalStatus', [ $withdraw->id, 'status' => 'awaiting' ] ) }}" class="menu-link px-3">Awaiting</a>
                                            </div>
