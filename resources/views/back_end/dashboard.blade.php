        ...
        <div class="row g-5 g-xl-8">
            ...
            <div class="col-xl-12">
                ...
                <div class="card card-xxl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Latest Deposits</span>

                        </h3>
                        <div class="card-toolbar">
                            <ul class="nav">
                                <li class="nav-item">
                                    <a href="{{ route('depositlists')}}" class="btn btn-primary btn-sm" href="#kt_table_widget_5_tab_1">Go to deposits</a>
                                </li>
        ...
        <div class="row g-5 g-xl-8">
            ...
            <div class="col-xl-12">
                ...
                <div class="card card-xxl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Latest withdrawals</span>

                        </h3>
                        <div class="card-toolbar">
                            <ul class="nav">
                                <li class="nav-item">
                                    <a class="btn btn-primary btn-sm" href="{{ route('withdrawals')}}">Go to withdrawals</a>
                                </li>
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                                        ...
                                        <tbody class="text-gray-600 fw-bold">
                                            ...
                                            <tr>
                                                ...
                                                <!--begin::Customer=-->
                                                <td>
                                                    <a href=""><strong>{{ $withdraw->user->name}}</strong></a>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="badge badge-light-warning">{{ $withdraw->status}}</div>
                                                    @elseif($withdraw->status == 'approved')
                                                    <div class="badge badge-light-success">{{ $withdraw->status}}</div>
                                                    @elseif($withdraw->status == 'unapproved')
                                                    <div class="badge badge-light-danger">{{ $withdraw->status}}</div>
                                                    @else
                                                    <div class="badge badge-light-primary">{{ $withdraw->status}}</div>
                                                    @endif
